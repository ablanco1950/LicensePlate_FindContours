...
def DetectLicenseInCar(gray):
    ...
    if len(TabCordsLicensesDetected) > 0:
        ...
        print(License + "  detected with Otsu's thresholding of cv2 and THRESH_BINARY ")
        for i in range(len(TabCordsLicensesDetected)):
          TabCordsLicensesDetectedTotal.append(TabCordsLicensesDetected[i])
          
    
    ret, gray1 = cv2.threshold(gray,0,255,cv2.THRESH_BINARY_INV+cv2.THRESH_OTSU)
    TabCordsLicensesDetected=DetectLicenseInCar1(gray1, ret)
    
    if len(TabCordsLicensesDetected) > 0:
       
        print(License + "  detected with Otsu's thresholding of cv2 and THRESH_BINARY_INV")
        for i in range(len(TabCordsLicensesDetected)):
          TabCordsLicensesDetectedTotal.append(TabCordsLicensesDetected[i])
    ...
    if len(TabCordsLicensesDetected) > 0:
        ...
        print(License + "  detected with Otsu's thresholding of cv2 and THRESH_TRUNC ")
        for i in range(len(TabCordsLicensesDetected)):
          TabCordsLicensesDetectedTotal.append(TabCordsLicensesDetected[i])
        #return TabLicensesDetected 
    ...
    if len(TabCordsLicensesDetected) > 0:
        ...
        print(License + "  detected with Otsu's thresholding of cv2 and THRESH_TOZERO ")
        for i in range(len(TabCordsLicensesDetected)):
          TabCordsLicensesDetectedTotal.append(TabCordsLicensesDetected[i])
        #return TabLicensesDetected 
    
  
    ret, gray1 = cv2.threshold(gray,0,255,cv2.THRESH_TOZERO_INV+cv2.THRESH_OTSU)
    TabCordsLicensesDetected=DetectLicenseInCar1(gray1,ret)
    
    if len(TabCordsLicensesDetected) > 0:
       
        print(License + "  detected with Otsu's thresholding of cv2 and THRESH_TOZERO_INV ")
        for i in range(len(TabCordsLicensesDetected)):
          TabCordsLicensesDetectedTotal.append(TabCordsLicensesDetected[i])
        #return TabLicensesDetected 
    ...
    if len(TabCordsLicensesDetected) > 0:
        ...
        print(License + "  detected with Brightness and THRESH_TRUNC ")
        for i in range(len(TabCordsLicensesDetected)):
          TabCordsLicensesDetectedTotal.append(TabCordsLicensesDetected[i])
    ...
    if len(TabCordsLicensesDetected) > 0:
        ...
        print(License + "  detected with Brightness and THRESH_TRUNC and medianBlur")
        for i in range(len(TabCordsLicensesDetected)):
          TabCordsLicensesDetectedTotal.append(TabCordsLicensesDetected[i]) 
    ...
    if len(TabCordsLicensesDetected) > 0:
        ...
        print(License + "  detected with Brightness and THRESH_TRUNC and GaussianBlur")
        for i in range(len(TabCordsLicensesDetected)):
          TabCordsLicensesDetectedTotal.append(TabCordsLicensesDetected[i]) 
    ...
    if len(TabCordsLicensesDetected) > 0:
        ...
        print(License + "  detected with Brightness and THRESH_BINARY and BilateralFilter")
        for i in range(len(TabCordsLicensesDetected)):
          TabCordsLicensesDetectedTotal.append(TabCordsLicensesDetected[i]) 
    ...
    if len(TabCordsLicensesDetected) > 0:
        ...
        print(License + "  detected with Brightness and THRESH_TOZERO and BilateralFilter")
        for i in range(len(TabCordsLicensesDetected)):
          TabCordsLicensesDetectedTotal.append(TabCordsLicensesDetected[i]) 
    ...
    if len(TabCordsLicensesDetected) > 0:
        ...
        print(License + "  detected with Brightness and THRESH_TOZERO_INV")
        for i in range(len(TabCordsLicensesDetected)):
          TabCordsLicensesDetectedTotal.append(TabCordsLicensesDetected[i]) 
    ...
    if len(TabCordsLicensesDetected) > 0:
        ...
        print(License + "  detected with Stable and THRESH_TRUNC")
        for i in range(len(TabCordsLicensesDetected)):
          TabCordsLicensesDetectedTotal.append(TabCordsLicensesDetected[i]) 
    ...
    if len(TabCordsLicensesDetected) > 0:
        ...
        print(License + "  detected with Stable and THRESH_BINARY and BilateralFilter")
        for i in range(len(TabCordsLicensesDetected)):
          TabCordsLicensesDetectedTotal.append(TabCordsLicensesDetected[i])
    ...
    if len(TabCordsLicensesDetected) > 0:
        ...
        print(License + "  detected with Stable and THRESH_BINARY_INV ")
        for i in range(len(TabCordsLicensesDetected)):
          TabCordsLicensesDetectedTotal.append(TabCordsLicensesDetected[i])
    ...
    if len(TabCordsLicensesDetected) > 0:
        ...
        print(License + "  detected with Stable and THRESH_TOZERO ")
        for i in range(len(TabCordsLicensesDetected)):
          TabCordsLicensesDetectedTotal.append(TabCordsLicensesDetected[i])   
    ...
    if len(TabCordsLicensesDetected) > 0:
        ...
        print(License + "  detected with Stable and THRESH_TOZERO_INV ")
        for i in range(len(TabCordsLicensesDetected)):
          TabCordsLicensesDetectedTotal.append(TabCordsLicensesDetected[i])
...
def FindLicenseNumber (gray_input, x_offset, y_offset,  License, x_resize, y_resize, \
                       Resize_xfactor, Resize_yfactor, BilateralOption, TabLicensesDetected):
#########################################################################
# adapted from:
...
####
    if BilateralOption ==1:
       gray_input= cv2.bilateralFilter(gray_input,3, 75, 75)
   
    #if Licenses[i]=="25810X":
    #    return 0
...
for i in range (len(imagesComplete)):
        ...
        while (SwFounded==0 and ContLoop <5):
            ContLoop+=1
            SwFounded= FindLicenseNumber (gray, x_off, y_off,  License, x_resize, y_resize, \
                               Resize_xfactor, Resize_yfactor, BilateralOption, TabCordsLicencesDetected)
            if SwFounded==-1:
                TotNoDetect=TotNoDetect+1
                break
